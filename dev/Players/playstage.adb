...
S:Lplaystage.InitStageData$tilemap_l$1$113({2}DG,SC:U),B,1,-6
S:Lplaystage.InitStageData$tilemap_l_size$1$113({2}SI:U),B,1,-8
S:Lplaystage.InitStageData$tilemap_m$1$113({2}DG,SC:U),B,1,-10
S:Lplaystage.InitStageData$psg$1$113({2}DG,SC:U),R,0,0,[c,b]
S:Lplaystage.InitStageData$psg_bank$1$113({2}SI:U),B,1,-12
