...
S:Lplayershoot.DrawPlayerShoot$ps$1$85({2}DG,STplayershoot:S),B,1,4
S:Lplayershoot.DrawPlayerShoot$sloc0$1$0({2}DG,SC:U),B,1,-4
S:Lplayershoot.DrawPlayerShoot$sloc1$1$0({1}SC:U),B,1,-1
S:Lplayershoot.DrawPlayerShoot$sloc2$1$0({1}SC:U),B,1,-2
...
S:Lplayershoot.UpdatePlayershoot$a$1$93({2}SI:U),B,1,4
S:Lplayershoot.UpdatePlayershoot$en$1$94({2}DG,STenemy:S),R,0,0,[e,d]
S:Lplayershoot.UpdatePlayershoot$b$1$94({1}SC:S),R,0,0,[b]
S:Lplayershoot.UpdatePlayershoot$ps$1$94({2}DG,STplayershoot:S),B,1,-4
S:Lplayershoot.UpdatePlayershoot$sloc0$1$0({2}SI:S),B,1,-2
F:G$UpdatePlayershoots$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.UpdatePlayershoots$a$1$103({1}SC:S),R,0,0,[]
F:G$InitPlayershoot$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayershoot.InitPlayershoot$x$1$105({1}SC:U),B,1,4
S:Lplayershoot.InitPlayershoot$y$1$105({1}SC:U),B,1,5
S:Lplayershoot.InitPlayershoot$t$1$105({1}SC:U),B,1,6
S:Lplayershoot.InitPlayershoot$ps$1$106({2}DG,STplayershoot:S),R,0,0,[c,b]
