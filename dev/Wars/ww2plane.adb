...
S:Lww2plane.InitWW2Plane$en$1$49({2}DG,STenemy:S),B,1,4
S:Lww2plane.InitWW2Plane$pat$1$50({2}DG,SC:U),R,0,0,[e,d]
...
S:Lww2plane.UpdateWW2Plane$sloc3$1$0({1}SC:U),B,1,-2
