...
S:Lstage6endboss.ResetSkullState$en$1$70({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.ResetSkullState$st$1$70({2}SI:U),B,1,6
S:Lstage6endboss.ResetSkullState$rec$1$70({1}SC:U),B,1,8
F:G$CreateCustomBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.CreateCustomBoneC$x$1$72({1}SC:U),B,1,4
S:Lstage6endboss.CreateCustomBoneC$y$1$72({1}SC:U),B,1,5
S:Lstage6endboss.CreateCustomBoneC$vx$1$72({1}SC:U),B,1,6
S:Lstage6endboss.CreateCustomBoneC$vy$1$72({1}SC:U),B,1,7
S:Lstage6endboss.CreateCustomBoneC$enm$1$73({2}DG,STenemy:S),R,0,0,[c,b]
F:G$LaunchSkullBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.LaunchSkullBoneC$en$1$74({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.LaunchSkullBoneC$vy$1$74({1}SC:U),B,1,6
S:Lstage6endboss.LaunchSkullBoneC$sloc0$1$0({1}SC:U),B,1,-2
S:Lstage6endboss.LaunchSkullBoneC$sloc1$1$0({1}SC:U),B,1,-1
F:G$DoSkullShootDirection$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.DoSkullShootDirection$en$1$77({2}DG,STenemy:S),B,1,4
F:G$DoSkullShootDirectionB$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage6endboss.DoSkullShootDirectionB$en$1$79({2}DG,STenemy:S),B,1,4
S:Lstage6endboss.DoSkullShootDirectionB$a$1$80({1}SC:U),R,0,0,[d]
S:Lstage6endboss.DoSkullShootDirectionB$sloc0$1$0({2}DG,SC:U),B,1,-2
S:Lstage6endboss.DoSkullShootDirectionB$sloc1$1$0({1}SC:U),B,1,-3
F:G$UpdateStage6EndBoss$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage6endboss.UpdateStage6EndBoss$en$1$82({2}DG,STenemy:S),B,1,4
