...
S:Lstage7.CheckStage7PlayerMovement$ny$1$80({2}SI:U),R,0,0,[c,b]
S:Lstage7.CheckStage7PlayerMovement$l$1$80({1}SC:U),R,0,0,[e]
S:Lstage7.CheckStage7PlayerMovement$m$1$80({1}SC:U),R,0,0,[c]
S:Lstage7.CheckStage7PlayerMovement$nl$1$80({2}SI:U),R,0,0,[c,b]
F:G$UpdateStage7$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstage7.UpdateStage7$sf$1$82({2}SI:U),R,0,0,[l,h]
F:G$InitStage7$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CheckCollisionStage7$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstage7.CheckCollisionStage7$x$1$85({1}SC:U),B,1,4
S:Lstage7.CheckCollisionStage7$y$1$85({1}SC:U),B,1,5
