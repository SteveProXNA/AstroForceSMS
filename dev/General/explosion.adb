...
S:Lexplosion.RemoveExplosion$a$1$75({1}SC:S),B,1,4
S:Lexplosion.RemoveExplosion$exa$1$76({2}DG,STexplosion:S),R,0,0,[c,b]
S:Lexplosion.RemoveExplosion$exb$1$76({2}DG,STexplosion:S),R,0,0,[]
F:G$UpdateExplosion$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lexplosion.UpdateExplosion$a$1$78({2}SI:U),B,1,4
S:Lexplosion.UpdateExplosion$ex$1$79({2}DG,STexplosion:S),B,1,-4
S:Lexplosion.UpdateExplosion$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$UpdateExplosions$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lexplosion.UpdateExplosions$a$1$84({1}SC:S),R,0,0,[]
