...
S:Lwaveship.InitWaveShip$en$1$49({2}DG,STenemy:S),B,1,4
F:G$UpdateWaveShip$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lwaveship.UpdateWaveShip$en$1$51({2}DG,STenemy:S),B,1,4
S:Lwaveship.UpdateWaveShip$p$1$52({2}SI:S),R,0,0,[]
