...
S:Lmap.getTileAt$x$1$82({1}SC:U),B,1,4
S:Lmap.getTileAt$y$1$82({1}SC:U),B,1,5
S:Lmap.getTileAt$nl$1$83({2}SI:U),R,0,0,[c,b]
S:Lmap.getTileAt$t$1$83({1}SC:U),R,0,0,[l]
F:G$SetMapLines$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap.SetMapLines$lines$1$84({2}DG,SC:U),B,1,4
S:Lmap.SetMapLines$lsize$1$84({2}SI:U),B,1,6
S:Lmap.SetMapLines$tiles$1$84({2}DG,SC:U),B,1,8
F:G$SetStaticEnemies$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap.SetStaticEnemies$p$1$86({2}DG,SI:U),B,1,4
S:Lmap.SetStaticEnemies$b$1$86({1}SC:U),B,1,6
F:G$DrawMap$0$0({2}DF,SV:S),Z,0,2,0,0,0
S:Lmap.DrawMap$a$1$88({2}SI:S),R,0,0,[c,b]
S:Lmap.DrawMap$b$1$88({2}SI:S),B,1,-2
S:Lmap.DrawMap$c$1$88({2}SI:S),R,0,0,[l,h]
F:G$InitMap$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap.InitMap$mb$1$91({1}SC:U),B,1,4
F:G$MoveMap$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lmap.MoveMap$mvx$1$93({2}SI:S),B,1,4
S:Lmap.MoveMap$mvy$1$93({2}SI:S),B,1,6
S:Lmap.MoveMap$a$1$94({2}SI:S),R,0,0,[c,b]
S:Lmap.MoveMap$c$1$94({2}SI:S),R,0,0,[l,h]
S:Lmap.MoveMap$mpy2$1$94({2}SI:U),R,0,0,[l,h]
S:Lmap.MoveMap$mpy5$1$94({2}SI:U),R,0,0,[c,b]
