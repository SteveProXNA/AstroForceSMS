...
S:Lskullbone.InitSkullBoneA$en$1$58({2}DG,STenemy:S),B,1,4
F:G$InitSkullBoneB$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.InitSkullBoneB$en$1$60({2}DG,STenemy:S),B,1,4
F:G$InitSkullBoneC$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.InitSkullBoneC$en$1$62({2}DG,STenemy:S),B,1,4
F:G$UpdateSkullBoneAB$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneAB$en$1$64({2}DG,STenemy:S),B,1,4
S:Lskullbone.UpdateSkullBoneAB$sloc0$1$0({2}DG,SC:U),B,1,-2
F:G$UpdateSkullBoneCMovement$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneCMovement$en$1$67({2}DG,STenemy:S),B,1,4
F:G$UpdateSkullBoneC$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lskullbone.UpdateSkullBoneC$en$1$70({2}DG,STenemy:S),B,1,4
