...
S:Lwarning.InitWarning$en$1$75({2}DG,STenemy:S),B,1,4
F:G$UpdateWarning$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lwarning.UpdateWarning$en$1$77({2}DG,STenemy:S),B,1,4
S:Lwarning.UpdateWarning$s$1$78({2}SI:U),R,0,0,[c,b]
S:Lwarning.UpdateWarning$x$1$78({1}SC:U),R,0,0,[l]
S:Lwarning.UpdateWarning$y$1$78({1}SC:U),R,0,0,[e]
