...
void InitSelectorStage()
{
	...
	// Load palette
	LoadBGPalette( ( unsigned char * ) selectorpalette_bin, selectorpalette_bin_bank );

	// Load tiles
	LoadTiles( ( unsigned char * ) selectortiles_psgcompr, selectortiles_psgcompr_bank );
	...
	// Rom bank
	PlayMusic( ( unsigned char * ) select_psg, select_psg_bank, 1 );
